...
# User Context Box (Pre-filled with your persona)
default_context = "no code AI enthusiast that likes to build things with AI. I am looking to build something that solves a problem and want to scale that to 5-10k/mo recurring revenue. I like starter story bc theres lots of non technical people building things like I am."

user_context = st.text_area("Who are you?", value=default_context, height=100)
...
if st.button("🚀 Build My Framework") and uploaded_file and user_context:
    try:
        ...
        # USE THE EXACT MODEL NAME FOUND IN SCANNER
